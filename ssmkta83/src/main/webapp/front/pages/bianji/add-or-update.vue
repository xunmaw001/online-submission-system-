	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`bianji`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
				if((!this.ruleForm.bianjizhanghao)){
				...
				if((!this.ruleForm.bianjixingming)){
				...
				if(this.ruleForm.id){
					await this.$api.update(`bianji`, this.ruleForm);
				}else{
					await this.$api.add(`bianji`, this.ruleForm);
				}
